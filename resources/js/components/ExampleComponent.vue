    ...
    <div class="container mt-5 bg-light">
        <div class="row">
            <div class="col-md-4 mt-5">
                <div class="card">
                    <div class="card-header bg-info text-white">Registro de vehiculos</div>
                        ...
                        <form @submit.prevent="nuevoVehiculo" @reset.prevent="limpiarFormulario">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" v-model="vehiculo.marca" required autofocus
                                        pattern="^[A-Z]{3,25}$" title="Solo se aceptan letras mayusculas">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" v-model="vehiculo.modelo" required
                                        pattern="^[A-Za-z]{4,25}$" title="Solo se aceptan letras">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="number" class="form-control" v-model="vehiculo.year" required
                                        pattern="^[0-9]{4}$" title="Solo se aceptan numeros" min="0000" max="9999">
                                </div>
                            </div>

                            <div class="form-group row">
                                <label for="num_motor" class="col-md-4 col-form-label text-md-right">Numero de
                                    motor</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <label for="Num_chasis" class="col-md-4 col-form-label text-md-right">Numero de
                                    chasis</label>
                                <div class="col-md-6">
            ...
            <div class="col-md-8 mt-5 ">
                <div class="card">
                    <div class="card-header bg-info text-white">Lista de vehiculos</div>
                    <div class="card-body">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr v-for="vehiculo in vehiculos" :key="vehiculo.id" @click="editarVehiculo(vehiculo)"
                                    :class="{ 'd-none': !vehiculo.mostrar }">
                                    ...
                                    <td>
                                        <button class="btn btn-danger"
                                            @click="eliminarVehiculo(vehiculo.idVehiculo)">Eliminar</button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
